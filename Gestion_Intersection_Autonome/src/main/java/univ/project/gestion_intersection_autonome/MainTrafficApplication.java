...
//        Vehicule v1 = new Vehicule(TypeVehicule.VOITURE, new Vector2D(3, 4), new Vector2D(4, 5), terrain);
//        Vehicule v2 = new Vehicule(TypeVehicule.VOITURE, new Vector2D(6, 7), new Vector2D(7, 8), terrain);
//        Vehicule v3 = new Vehicule(TypeVehicule.VOITURE, new Vector2D(5, 5), new Vector2D(6, 6), terrain);
//
